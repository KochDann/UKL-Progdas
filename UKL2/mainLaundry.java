    ...
    public static void main(String[] args) {
        ...
        while (stay) {
            ...
            if (menu == 1) {
                ...
                for (Transaksi listTransaksi1 : listTransaksi) {
                    System.out.println(listTransaksi1.selectedLaundry.getJenisLaundry() + " \t " + listTransaksi1.selectedLaundry.getHarga() + " \t " + listTransaksi1.jumlah + " \t " + listTransaksi1.total);
                    total += listTransaksi1.total;
                }
